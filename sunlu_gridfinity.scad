...
translate([-spool_width/2,0,0]) group() {
translate([-16.2 * 9 - 16.2/2,-spool_diameter*3,0])
for(i = [0:len(sunlu_pla_plus_2)-1]) {
	if(i == 0) {
	color("White") translate([0,-spool_diameter/2,55]) text(text="PLA+ 2.0");
	}
	color("Red") translate([16.2*i,-10,30]) rotate([0,90,0]) spool();
}

translate([-16.2 * 8 - 16.2/2,-spool_diameter*2,0])
for(i = [0:len(sunlu_rapid_marble)-1]) {
	if(i == 0) {
		color("White") translate([0,-spool_diameter/2,55]) text(text="PLA Marble");
	}
	color("Brown") translate([16.2*i,-10,30]) rotate([0,90,0]) spool();
}

translate([-16.2 * 1 - 16.2/2 ,-spool_diameter*2,0])
...
translate([16.2 * 4 - 16.2/2,-spool_diameter*2,0])
...
translate([16.2 * 2  - 16.2/2,-spool_diameter*1,0])
for(i = [0:len(sunlu_pla_silk)-1]) {
	if(i == 0) {
		color("White") translate([-10,-spool_diameter/2,55]) text(text="PLA Silk");
	}
	color("Pink") translate([16.2*i,-10,30]) rotate([0,90,0]) spool();
}
...
translate([-16.2 * 3.5 - 16.2/2 ,-spool_diameter*0,0])
for(i = [0:len(sunlu_pla_dual)-1]) {
	if(i == 0) {
		color("White") translate([20,-spool_diameter/2,55]) text(text="PLA Silk Dual");
	}
	color("Lime") translate([16.2*i,-10,30]) rotate([0,90,0]) spool();
}

translate([16.2 * 5 - 16.2/2,spool_diameter*0,0])
...
translate([-16.2 * 9 - 16.2/2,-spool_diameter*0,0])
...
translate([-16.2 * 8 - 16.2/2,spool_diameter*1,0])
for(i = [0:len(sunlu_pvb)-1]) {
	if(i == 0) {
		color("White") translate([0,-spool_diameter/2,55]) text(text="sunlu_pvb");
	}
	color("Black") translate([16.2*i,-10,30]) rotate([0,90,0]) spool();
}


translate([-16.2 * 0.5 - 16.2/2,spool_diameter*1,0])
...
translate([16.2 * 6 - 16.2/2 ,spool_diameter*1,0])
...
for(i = [0:len(sunlu_pc_abs)-1]) {
	...
	color("White") translate([16.2*i,-10,30]) rotate([0,90,0]) spool();
}
